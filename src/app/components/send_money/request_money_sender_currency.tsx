...
export default function ReceiverGets({ }) {
    const currencies = [
    ...
    return (
        <span className="input-group-text p-0">
            ...
            <select id="recipientCurrency" data-style="form-select border-0" data-container="body" data-live-search="true" className="selectpicker bg-transparent form-control" defaultValue={"AUD"}>
                {/* <optgroup label="Popular Currency"> */}
                {currencies.slice(0, 3).map(currency => (
                    <option key={currency.code} data-icon={`currency-flag currency-flag-${currency.code.toLowerCase()} me-1`} data-subtext={currency.name} value={currency.code}>{currency.code}</option>
                ))}
                {/* </optgroup> */}
                {/* <option data-divider="true"></option> */}
                {/* <optgroup label="Other Currency"> */}
                {/* {currencies.slice(3).map(currency => (
                    <option key={currency.code} data-icon={`currency-flag currency-flag-${currency.code.toLowerCase()} me-1`} data-subtext={currency.name} value={currency.code}>{currency.code}</option>
                ))} */}
                {/* </optgroup> */}
            </select>
    ...
    //     <select id="recipientCurrency" data-style="form-select  border-0"

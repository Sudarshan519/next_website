export default function YouSend() {
    return (<span className="input-group-text p-0">

        <select id="youSendCurrency" className="selectpicker bg-transparent form-control"
            data-style="form-select bg-transparent border-0" data-container="body"
            data-live-search="true" required={false} defaultValue={"AED"}>
            ...
            <option data-icon="currency-flag currency-flag-aud me-1"
                data-subtext="United Arab Emirates dirham" value="">AUD</option>
